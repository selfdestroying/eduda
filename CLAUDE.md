...
Занятия, списанные «в долг» до перехода 10.08.2026, остались с выданными тогда ценами и в отчётах прошлых месяцев — в том числе ~450 строк с ценой 0 у кошельков, где пакета не было никогда. Цена у них проставлена, поэтому новая оплата их не подберёт: прошлые месяцы не переписываются.
