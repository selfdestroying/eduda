...
const TIPS = [
  ...
  'Пропущенный урок можно отработать. Отработка одна: если ученик не пришёл и на неё, занятие списывается.',
  ...
  'Оплата попала не на тот кошелёк? Пакет можно перенести на другой кошелёк того же ученика.',
