  ...
  return (
    <aside className="hidden w-66 flex-none flex-col gap-5 overflow-hidden border-r p-4 lg:flex">
      <div className="flex items-center gap-2.5 px-1">
        <div className="bg-primary text-primary-foreground flex size-7.5 items-center justify-center rounded-lg text-sm font-semibold tabular-nums">
          {todayNum}
        </div>
        <span className="text-base font-semibold tracking-tight">Календарь</span>
      </div>
