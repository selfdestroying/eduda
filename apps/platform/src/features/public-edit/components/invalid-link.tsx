      ...
      <div className="animate-landing-enter relative z-10 flex w-full max-w-sm flex-col items-center">
        <div className="mb-8 flex flex-col items-center gap-3">
          <div className="bg-muted/50 flex h-16 w-16 items-center justify-center rounded-2xl">
            <Link2Off className="text-muted-foreground size-7" />
          </div>
          <div className="flex flex-col items-center gap-1">
            <h1 className="text-4xl font-bold tracking-tight">Ошибка</h1>
            <p className="text-muted-foreground text-center text-sm">Ссылка недействительна</p>
          </div>
        </div>
