 ...
 * его комфортные 30%.
 *
 * Ниже упереться не выйдет из-за «Статуса» и «Даты»: их доли самые маленькие, и
 * при сумме меньше ~1060px бейдж «Корректировка» и «10.08.2026» начинают
 * обрезаться раньше, чем «Ученику» станет тесно.
 */
const WIDTHS = {
  student: 110,
  price: 130,
