...
/**
 * Ширины — в процентах: 15% забирает «Ученик», остальные 85% делят между собой
 ...
 * его доля.
 *
 * Раньше всех упираются «Статус» и «Дата» — их доли самые маленькие, и бейдж
 * «Корректировка» с «10.08.2026» перестают влезать примерно там же, где стоит
 * порог. Интервала, в котором они подрезаны, а «Ученику» ещё просторно, почти нет.
 */
const WIDTHS = {
  student: 110,
  price: 170,
